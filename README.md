...
2. Pipeline is automatically triggered
3. Code is processed (build/test stage if applicable)
4. AWS CodeDeploy deploys the application to EC2
5. Lifecycle scripts handle installation and application startup
